...
const CurrentWeather = ({currentLocation, currentDay, currentIcon, currentTemp, currentMinTemp, currentMaxTemp, currentUnits}) => {
    return (
        <header className="current-weather">
            <div className="current-weather__data">
                ...
                <p className="current-weather__data--current">{currentTemp}&#176;{currentUnits}</p>
